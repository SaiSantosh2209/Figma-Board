...
const Live = ({ canvasRef, undo, redo }: Props) => {
  ...
  const handlePointerDown = useCallback(
    (event: React.PointerEvent) => {
      ...
      // if cursor is in reaction, set isPressed to true
  ...
  return (
    <ContextMenu>
      ...
      >
        ...
        {/* Displaying a users with cursors who arfe online*/}
        <LiveCursors others={others} />

        {/* Comments is currently disabled */}
        {/* <Comments /> */}
      </ContextMenuTrigger>
