...
const LeftSidebar = ({ allShapes }: { allShapes: Array<any> }) => {
  ...
  const memoizedShapes = useMemo(
    () => ( //  Please flex ko felx nahi likho 2 din tak project undo hua 
      <section className="flex flex-col  border-t border-primary-grey-200 bg-primary-black text-primary-grey-300 min-w-[227px] sticky left-0  max-sm:hidden select-none overflow-y-auto pb-20">
